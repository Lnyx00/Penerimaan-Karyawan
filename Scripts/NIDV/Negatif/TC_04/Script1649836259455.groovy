...
statusRes =  WS.sendRequest(findTestObject('NIDV/Negatif/TC_4'))
...
//	CustomKeywords.'valiadasi.validasiApi.textValidasi'(resJson)
	validasi.append('------------------------------------------\n')
	...
	KeywordUtil.markFailed('error' + retValidasi)
	KeywordUtil.markError('error' + retValidasi)
}